...
export default withEnglishFallback({
  ...
  tabs: {
    ...
    moveTabWindowStopQueryTitle: "Interrompere SQL e spostare la scheda?",
    moveTabWindowStopQueryConfirm: "Questa scheda sta eseguendo SQL. Interromperlo e spostare la scheda in una nuova finestra?",
    moveTabWindowStopFailed: "Impossibile interrompere SQL. La scheda non è stata spostata.",
    moveTabWindowPendingGridChanges: "Salva o annulla le modifiche dati in sospeso prima di spostare la scheda",
    moveTabWindowActiveTransaction: "Esegui commit o rollback della transazione attiva prima di spostare la scheda",
    moveTabWindowPendingStructureChanges: "Salva o annulla le modifiche alla struttura prima di spostare la scheda",
    ...
    openTabUnavailable: "Questa scheda non è più disponibile",
    openTabWindowFailed: "Impossibile aprire la finestra della scheda: {message}",
    gridfs: "GridFS",
  ...
  contextMenu: {
    ...
    openInNewWindow: "Sposta in una nuova finestra",
