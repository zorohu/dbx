...
export default withEnglishFallback({
  ...
  tabs: {
    ...
    moveTabWindowStopQueryTitle: "Parar SQL e mover a aba?",
    moveTabWindowStopQueryConfirm: "Esta aba está executando SQL. Deseja interromper e mover a aba para uma nova janela?",
    moveTabWindowStopFailed: "Não foi possível interromper o SQL. A aba não foi movida.",
    moveTabWindowPendingGridChanges: "Salve ou descarte as alterações de dados pendentes antes de mover esta aba",
    moveTabWindowActiveTransaction: "Confirme ou reverta a transação ativa antes de mover esta aba",
    moveTabWindowPendingStructureChanges: "Salve ou descarte as alterações de estrutura antes de mover esta aba",
    ...
    openTabUnavailable: "Esta aba não está mais disponível",
    openTabWindowFailed: "Falha ao abrir a janela da aba: {message}",
    gridfs: "GridFS",
  ...
  contextMenu: {
    ...
    openInNewWindow: "Mover para nova janela",
