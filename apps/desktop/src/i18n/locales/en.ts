...
export default {
  ...
  tabs: {
    ...
    moveTabWindowStopQueryTitle: "Stop query and move tab?",
    moveTabWindowStopQueryConfirm: "This tab is running SQL. Stop it and move the tab to a new window?",
    moveTabWindowStopFailed: "The SQL could not be stopped. The tab was not moved.",
    moveTabWindowPendingGridChanges: "Save or discard pending data-grid changes before moving this tab",
    moveTabWindowActiveTransaction: "Commit or roll back the active transaction before moving this tab",
    moveTabWindowPendingStructureChanges: "Save or discard pending structure changes before moving this tab",
    ...
    openTabUnavailable: "This tab is no longer available",
    openTabWindowFailed: "Failed to open tab window: {message}",
  },
  gridfsBrowser: {
    bucketCount: "buckets",
    fileCount: "files",
  ...
  contextMenu: {
    ...
    openInNewWindow: "Move to New Window",
