...
export default withEnglishFallback({
  ...
  tabs: {
    ...
    moveTabWindowStopQueryTitle: "停止 SQL 並移出分頁？",
    moveTabWindowStopQueryConfirm: "此分頁正在執行 SQL。是否停止執行並將分頁移到新視窗？",
    moveTabWindowStopFailed: "無法停止 SQL，分頁未移出",
    moveTabWindowPendingGridChanges: "請先儲存或放棄表格中的待提交修改，再移出分頁",
    moveTabWindowActiveTransaction: "請先提交或回復目前交易，再移出分頁",
    moveTabWindowPendingStructureChanges: "請先儲存或放棄結構修改，再移出分頁",
    moveTabWindowPersistFailed: "分頁已移動，但儲存主視窗狀態失敗：{message}",
    closeTabWindowFailed: "關閉分頁視窗失敗：{message}",
    openTabUnavailable: "此分頁已無法使用",
    openTabWindowFailed: "開啟分頁視窗失敗：{message}",
    gridfs: "GridFS",
